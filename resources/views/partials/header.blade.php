...
<div class="topline flex">
    <div class="flex container blueline">
        <p>DC POWER℠ VISA®</p>
        <p class="m-l-50">ADDITIONAL DC SITES <span class="arrow">&#9660;</span></p>
    </div>
</div>
...
<nav class="flex container" style="justify-content: space-between; align-items: center;">
        ...
        <ul class="navlist">
                ...
                <li><a href="#" class="navlink">SHOP <span class="arrow" style="color: #0282f9;">&#9660;</span></a></li>        
        </ul>
